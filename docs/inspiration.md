...
- **Meshing and Remeshing of Polygon Meshes** (geração e remalhamento de malhas poligonais) — triangula faces, refina, simplifica, otimiza e suaviza malhas. Inclui o remalhamento isotrópico discutido no README; não é sinônimo de reduzir polígonos e pode mudar a contagem para cima ou para baixo. **Aderência: Alta** para uma ferramenta separada de remeshing.
...
3. **Remalhamento isotrópico:** Meshing and Remeshing of Polygon Meshes. Separar da simplificação planar: medir regularidade, desvio geométrico, tempo e número final de triângulos; a contagem pode subir.
